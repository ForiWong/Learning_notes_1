...
import com.wlp.myanjunote.kotlin3.kt4.BaseResult
import com.wlp.myanjunote.kotlin3.kt4.TranslateService
...
class TranslateViewModel : ViewModel() {
     ...
     * TODO
     */
    /*val translateResult: LiveData<Result<BaseResult<String>>> = inputLiveData.swswitchMap { input ->
        liveData {
            val result = try {
                // 网络返回成功
