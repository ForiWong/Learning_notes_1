...
import com.wlp.myanjunote.BuildConfig;
...
public class CircleProgress extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (useGradient) {
            /**
             * 我们的颜色渐变主要是用到Shader类，通过Paint.setShader(shader)方法为画笔Paint设置shader，这样就可以绘制出多彩的图形。那么Shader是什么呢？
             ...
             *
             * 作者：Angelicas
             * 链接：https://www.jianshu.com/p/0c7dca38207c
             * 来源：简书
    ...
    private void drawArc(Canvas canvas) {
        ...
        for (int i = 0; i < mDottedLineCount; i++) {
            ...
            canvas.drawLine(startX, startY, stopX, stopY, mBgArcPaint);//这个可以改成PathEffect实现
        }
